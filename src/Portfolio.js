  ...
  return (
    <div className="portfolio">
      <div className="header">
        <h1>Boya Karthik Naidu</h1>
        <h2>Student</h2>
        <div className="contact-info">
          <h3>
            <a href="mailto:karthik.21bce9600@vitapstudent.ac.in">karthik.21bce9600@vitapstudet.ac.in</a>
          </h3>
          <h3>Phone Number: 9502143192</h3>
        </div>
      </div>
      ...
      <div className="contact">
        ...
        <p>Email: 
            <a href="mailto:karthiknaiduboya8@gmail.com">karthiknaiduboya8@email.com</a></p><p>Phone: 9502143192
            </p></div></div>);
};
